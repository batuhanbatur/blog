...
const contactStyle = {
  ...
  color: "#1D1D0C",
  textDecoration: "none",
  border: "1px solid rgba(29, 29, 12, 0.3)",
  borderRadius: "4px",
  padding: "8px 20px",
}
    ...
    >
      <div style={{ display: "flex", alignItems: "flex-start", gap: "64px" }}>
        <div style={{ flex: 1 }}>
          ...
          <div
            style={{ fontSize: "18px", lineHeight: "1.8", color: "#1D1D0C" }}
          >
            <p style={{ margin: "0 0 24px 0" }}>
              Developer. Gamer. Runner. Anime lover.
            </p>
            <p style={{ margin: "0 0 24px 0", opacity: 0.7 }}>
              There are probably more words to describe me. These are just the
              first ones that come to mind.
            </p>
            <p style={{ margin: "0 0 24px 0", opacity: 0.7 }}>
              This blog is my first real step into a new world. Here, I
              experiment with different blog concepts while also treating this
              place a bit like a personal social platform. The project is still
              evolving. So am I.
            </p>
          </div>
          ...
          <div style={{ marginTop: "48px", marginBottom: "48px" }}>
            ...
            >
              New gaming buddies? Always open to that. Feel free to add me on
              Steam, League of Legends, or Battle.net (Avare#21640).
            </p>
            ...
            >
              <a
                href="https://steamcommunity.com/id/batuachn"
                target="_blank"
                rel="noopener noreferrer"
                style={linkStyle}
              >
                <img
                  src="https://cdn.simpleicons.org/steam/1D1D0C"
                  width="14"
                  height="14"
                  alt="Steam"
                />
              ...
              <div style={tagStyle}>
                <img
                  src="https://cdn.simpleicons.org/riotgames/1D1D0C"
                  width="14"
                  height="14"
                  alt="League"
                />
            ...
            >
              Curious about my anime taste? Check out my MyAnimeList profile:
            </p>

            <a
              href="https://myanimelist.net/profile/batuhanbatur"
              target="_blank"
              rel="noopener noreferrer"
              style={{ ...linkStyle, display: "inline-flex" }}
            >
              <img
                src="https://cdn.simpleicons.org/myanimelist/1D1D0C"
                width="14"
                height="14"
                alt="MAL"
              />
